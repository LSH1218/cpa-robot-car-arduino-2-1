...
#define MTR0_MID    253     // 좌측 모터 중속에 해당하는 값으로 최대 255
#define MTR0_LOW    252     // 좌측 모터 저속에 해당하는 값으로 최대 255

//- 모터1(8, 23 핀 이용)의 PWM 매크로 값
#define MTR1_HIGH   254     // 우측 모터 고속에 해당하는 값으로 최대 255
#define MTR1_MID    253     // 우측 모터 중속에 해당하는 값으로 최대 255
#define MTR1_LOW    252     // 우측 모터 저속에 해당하는 값으로 최대 255

//- 모터2(9, 24 핀 이용)의 PWM 매크로 값
#define MTR2_HIGH   254     // 모터2 고속에 해당하는 값으로 최대 255 (너무 크면 문제 됨)
#define MTR2_MID    230     // 모터2 중속에 해당하는 값으로 최대 255 (너무 크면 문제 됨)
#define MTR2_LOW    200     // 모터2 저속에 해당하는 값으로 최대 255 (너무 크면 문제 됨)

//- 모터3(10, 25 핀 이용)의 PWM 매크로 값
#define MTR3_HIGH   254     // 모터3 고속에 해당하는 값으로 최대 255 (너무 크면 문제 됨)
#define MTR3_MID    230     // 모터3 중속에 해당하는 값으로 최대 255 (너무 크면 문제 됨)
#define MTR3_LOW    200     // 모터3 저속에 해당하는 값으로 최대 255 (너무 크면 문제 됨)
